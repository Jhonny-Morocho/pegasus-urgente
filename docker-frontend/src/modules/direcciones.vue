    ...
    <div class="col-12">
      ...
      <div class="grid">
        ...
        <AppInput
          ...
          :disabled="disabled"
          label="Calle"
          :rules="!esRural ? { required } : undefined"
        />
        <AppInput
          id="numero"
        ...
        />
        <div class="col-12 md:col-6 lg:col-3 p-fluid pl-3">
          <AppCheckbox
            id="es-principal"
            v-model="formData.esPrincipal"
            class="my-auto"
            :disabled="readOnly"
...
const { formData } = useDelitoProvide()

const { regiones, comuna, mantenedor_getRegiones, mantenedor_getComunas, mantenedor_getIdRegionByNombre, mantenedor_getIdComunaByNombre, mantenedor_getComunasByIdRegion } = useMantenedorStore()

const modoManual = ref(false)
const esRural = ref(false)
const comunasOptions = ref(null)
const disabled = computed(() => (!esRural.value && !modoManual.value) || props.readOnly)
