...
<section class="w-full">
  <AppDataTable
    id="tabla-causas-relacionadas-saf"
    :loading="causasEncontradasSaf.isLoading"
    :rows="causasEncontradasSaf.paginacion?.tamanoPagina"
    :total-records="causasEncontradasSaf.paginacion?.elementosTotales"
    :value="causasEncontradasSaf.data"
...
defineProps({
  causasEncontradasSaf: propTypes.object
})
