...
import TablaGestorSolicitudes from '@/modules/gestion-solicitudes/components/bandejas/TablaGestorSolicitudes.vue'
...
function tabChange ({ index }) {
  switch (index) {
    case 0:
      ...
      gestionSolicitud.filters.status = `${taskStatus.RESERVED}`
      break
    case 1:
