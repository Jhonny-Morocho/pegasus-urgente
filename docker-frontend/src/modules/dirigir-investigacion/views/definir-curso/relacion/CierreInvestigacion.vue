...
<section>
  ...
  >
    <AppFieldset legend="Relación - Cierre de Investigación">
      <TablaRelaciones
        ...
        @page="getRelaciones"
      />
      <AccionDeCierre v-model="formData" />
    </AppFieldset>
  </AppForm>
...
import AccionDeCierre from '@/modules/dirigir-investigacion/components/definir-curso-relacion/cierre/AccionDeCierre.vue'
...
async function completarTareaPam () {
  ...
  const payload = {
    ...
    subTipoTermino: '--',
    motivoTermino: formData.motivoCierre,
