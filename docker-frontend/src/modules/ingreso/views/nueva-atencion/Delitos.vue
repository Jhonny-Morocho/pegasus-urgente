...
<script setup>
import { defineEmits, nextTick, onMounted, provide, reactive, ref } from 'vue'
...
function handleNextStep () {
  if (delitos.value?.length > 0) {
    ...
    setTimeout(() => {
      ...
      emit('next-step', '/ingreso/denuncia-directa/nueva-denuncia/relaciones')
    }, 600)
  } else {
