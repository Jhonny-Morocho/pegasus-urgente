...
>
  <Column header="Familia Especie">
    <template #body="{ data }">
      {{ familiaEspecie(data?.familiaEspecie) || data?.familiaEspecieDescripcion || 'No esta el id en el mantenedor' }}
    </template>
  </Column>
  <Column header="Tipo Especie">
    <template #body="{ data }">
      {{ tipoEspecie(data?.idTipoEspecie) || data.tipoEspecie || 'No esta el id en el mantenedor' }}
    </template>
  </Column>
