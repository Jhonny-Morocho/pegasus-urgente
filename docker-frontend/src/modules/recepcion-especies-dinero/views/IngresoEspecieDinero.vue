...
const ingresoEspeciesYDinerosSteps = [
  {
    ...
    to: `/custodia/custodio/nuevo-ingreso/ingresar-datos-adicionales`
  },
  {
    label: 'Fijación Fotográfica',
    to: `/custodia/custodio/nuevo-ingreso/fijacion-fotografica`
  },
  {
    label: 'Asignar Ubicación',
    to: `/custodia/custodio/nuevo-ingreso/asignar-ubicacion`
  },
  {
    label: 'Generar Etiqueta',
    to: '/custodia/custodio/nuevo-ingreso/generar-etiqueta-ingreso'
  }
]
