...
<div class="col-12">
  <div class="grid">
    ...
    <div class="col-12 md:col-3 flex justify-content-space-between perfil-firma m-0">
      <img
        v-if="!form.foto"
        id="imagen-perfil"
        alt="img-perfil"
      ...
      <img
        ...
        :src="`data:image/jpg;base64,${form.foto}`"
        style="width: 45%; margin: auto"
      >
    ...
    <div v-if="!form.representaInstitucion || mantenedor_getTipoPersonaById(form.idRepresentaInstitucion) !== '1'">
      <div class="col-12">
        <div class="grid">
          <div class="col-12 grid">
            <AppCheckbox
              ...
              :disabled="(form.hasSrceiData && mantenedor_getCodigoTipoDocumentoIdentidad(form.tipoDocumentoIdentificacion) !== '0') || form.readonly"
              label="NN"
              placeholder="Top"
              @change="setDataNN"
            />
          ...
          >
            <AppInput
              ...
              :disabled="!form.tipoDocumentoIdentificacion || codigoTipoDocumento === '0'"
            ...
            <Button
              ...
              :disabled="!form.tipoDocumentoIdentificacion || codigoTipoDocumento !== '1' || form.readonly"
              icon="pi pi-search"
          ...
          >
            <AppDropdown
              ...
              :disabled="(form.hasSrceiData && form.tipoDocumentoIdentificacion !== '') || codigoTipoDocumento === '1' || codigoTipoDocumento === '0'"
              label="País del Documento"
              option-label="descripcion"
              option-value="id"
              :options="paises"
              :retrieve-data-action="mantenedor_getPaises"
              :rules="codigoTipoDocumento !== '0' && codigoTipoDocumento !== '1' ? { required } : undefined"
              show-clear
            />
          </div>
          <div class="col-12 md:col-6 lg:col-3 pt-3">
            <AppCheckbox
              ...
              :disabled="(form.hasSrceiData && codigoTipoDocumento !== '0') || form.readonly"
          ...
          <AppDropdown
            ...
            :rules="form.nacionalidad !== mantenedor_getIdPaisByCodigo('15') && form.nacionalidad !== '' ? { required } : undefined"
            show-clear
          />
          <AppDropdown
...
import { useSujetosIntervinientesInject, useSujetosIntervinientesStore, useMantenedorStore } from '@/modules/global/composables'
...
const codigoTipoDocumento = computed(() => mantenedor_getCodigoTipoDocumentoIdentidad(form.tipoDocumentoIdentificacion))
...
watch(
  ...
  () => {
    if (form.representaInstitucion === true) {
...
const tipoSujeto = computed(() => mantenedor_getCodigoTipoSujeto(form.tipoSujeto))
...
function mantenedores () {
  ...
  requestUtil({ action: mantenedor_getTiposPersona })
}
...
function setTipoDocumentoIdentificacion () {
  if (codigoTipoDocumento.value !== '0' && codigoTipoDocumento.value !== undefined) {
...
function setDataNN () {
  if (form.esNn) {
    form.tipoDocumentoIdentificacion = mantenedor_getIdTipoDocumentoIdentidadByCodigo('0')
...
const { sujetosInvervinientes_getInformacionSrcel, sujetosInvervinientes_getPoseeOrdenesDetencion } = useSujetosIntervinientesStore()
...
const srcel = async () => {
  if (mantenedor_getCodigoTipoDocumentoIdentidad(form.tipoDocumentoIdentificacion) === '1' && !isRutValid(form.numeroDocumentoIdentificacion)) {
  ...
  requestUtil({
    ...
    resolve: (v) => {
      // se setean los valores en base64 para
      ...
      if (v.origenInformacion) {
        ...
        requestUtil({
          ...
          payload: otroPayload,
          resolve: (v) => {
            console.log(v.tieneOrdenDetencionVigente)
            form.tieneOrdenDetencionVigente = false
          },
          reject: () => {
